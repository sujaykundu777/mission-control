...
import { Globe, Server, AlertCircle, Zap } from 'lucide-react'
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Manage and monitor all your domains</p>
        </div>
      ...
      <div>
        ...
        {domains.length === 0 ? (
          <div className="bg-card border border-border rounded-lg p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">Get started by adding your first domain</p>
            <Link href="/domains/add">
