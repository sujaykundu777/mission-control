    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex">
          <Button
            variant="outline"
            className="mx-2 border-border hover:bg-card"
      ...
      {filteredContacts.length !== 0 && (
        <div className="inline-flex rounded-md shadow-sm" role="group">
          <button
            ...
            } rounded-s-lg border border-gray-200 text-sm font-medium hover:bg-black hover:text-[#101827]`}
          >
            <svg
              width="20"
              height="20"
          ...
          <button
            ...
            } rounded-e-lg border border-gray-200 text-sm font-medium hover:bg-black hover:text-[#101827] focus:z-10`}
          >
            <svg
              width="20"
              height="20"
