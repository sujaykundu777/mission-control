    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-card border border-border rounded-lg p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-foreground mb-2">Domain not found</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-foreground mt-1">
                {domain.registrarUrl ? (
                  <a href={domain.registrarUrl} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                    {domain.registrar} ↗
                  </a>
                ) : (
                  domain.registrar
            ...
            <div>
              ...
              <p className="text-foreground mt-1">{new Date(domain.purchaseDate).toLocaleDateString()}</p>
            </div>
            <div>
              <p className="text-xs font-medium text-muted-foreground">EXPIRATION DATE</p>
              <p className="text-foreground mt-1">{new Date(domain.expirationDate).toLocaleDateString()}</p>
            </div>
            <div>
        ...
        <Card className="p-6 bg-card border-border">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-foreground mt-1">
                <a href={`mailto:${domain.contactInfo.email}`} className="text-primary hover:underline">
            ...
            {domain.contactInfo.phone && (
              <div>
                ...
                <p className="text-foreground mt-1">{domain.contactInfo.phone}</p>
              </div>
            )}
            {domain.notes && (
              <div>
