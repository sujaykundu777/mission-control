...
export async function generateContactSummary(
  ...
  try {
    ...
    const systemPrompt =
      " You are a helpful business assistant. Generate a concise, professional summary of a contact based on the information provided. Focus on key details, business relationship insights and notable information. Keep the summary 5-6 sentences maximum. Dont give summary title";
