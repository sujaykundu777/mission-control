    ...
    it('should calculate correct statistics', async () => {
      ...
      const domains: Domain[] = [
        createTestDomain({
          ...
          status: 'active',
          services: [
            { id: 's1', name: 'Hosting', type: 'hosting', status: 'active', billingCycle: 'monthly', cost: 10 },
            { id: 's2', name: 'SSL', type: 'ssl', status: 'active', billingCycle: 'annual', cost: 5 },
          ],
        }),
        createTestDomain({
          id: 'stats-2',
          status: 'active',
          services: [
            { id: 's3', name: 'CDN', type: 'cdn', status: 'active', billingCycle: 'monthly', cost: 20 },
          ],
        }),
        createTestDomain({
          id: 'stats-3',
