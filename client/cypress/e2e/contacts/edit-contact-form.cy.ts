describe('Edit Contact Form', () => {
  ...
  it('loads and displays the existing contact data', () => {
    ...
    // Notes
    cy.get('textarea[name="notes"]').should('have.value', 'A Fashion Designer Boutique in Bangalore')
  ...
  it('shows delete confirmation dialog and can cancel', () => {
    ...
    cy.get('[role="alertdialog"]').contains('Are you sure you want to delete this contact?').should('be.visible')
